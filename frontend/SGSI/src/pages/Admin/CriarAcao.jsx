...
const getCorStatus = (status) => {
  switch (status) {
    case "Concluído":
      return "border border-lime-500/20 text-lime-500 bg-lime-50";
    case "Em Andamento":
      return "border border-cyan-500/10 text-cyan-500 bg-cyan-50";
    default:
      return "border-violet-500/10 text-violet-500 bg-violet-50 border";
  }
};
